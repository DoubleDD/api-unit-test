...
public class LokiAppender extends UnsynchronizedAppenderBase<LoggingEvent> {
    ...
    protected Encoder<LoggingEvent> encoder;
    ...
    protected void append(LoggingEvent event) {
        if (encoder != null) {
            LogItem logItem = new LogItem(TimeUnit.MILLISECONDS.toNanos(event.getTimeStamp()), new String(encoder.encode(event)));
    ...
    public Encoder<LoggingEvent> getEncoder() {
        return encoder;
    }
